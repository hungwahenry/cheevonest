...
export const SYSTEM_CONFIGS: ReadonlyArray<SystemConfigSeed> = [
  ...
  { key: 'payouts.reconcile_stale_minutes', group: 'payouts', type: 'int', default: 15, description: 'Minutes a payout may sit in-flight before the reconciliation sweep pull-verifies or re-initiates it.' },
